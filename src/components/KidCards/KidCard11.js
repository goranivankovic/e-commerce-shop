    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b23 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp11))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/shoe3",  imgName :"/Img/kid/patike3.jpg", name:ik11, size:btnValue,price:kp11,}) )
