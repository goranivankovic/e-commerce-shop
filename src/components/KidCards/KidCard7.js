...
import womenJacket from '../../Img/kid/majica.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b19 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp7))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/tshirt",  imgName :"/Img/kid/majica.jpg", name:ik7, size:btnValue,price:kp7,}) )
