...
import womenJacket from '../../Img/kid/majica2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b20 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp8))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/tshirt2",  imgName :"/Img/kid/majica2.jpg", name:ik8, size:btnValue,price:kp8,}) )
