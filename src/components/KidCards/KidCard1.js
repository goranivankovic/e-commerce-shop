    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b13 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp1))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/jacket",  imgName :"/Img/kid/jakna.jpg", name:ik1, size:btnValue,price:kp1,}) )
