...
import womenJacket from '../../Img/kid/jeans2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b16 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp4))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/jeans2",  imgName :"/Img/kid/jeans2.jpg", name:ik4, size:btnValue,price:kp4,}) )
