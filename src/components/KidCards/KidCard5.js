...
import womenJacket from '../../Img/kid/duks.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b17 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp5))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/hoodie",  imgName :"/Img/kid/duks.jpg", name:ik5, size:btnValue,price:kp5,}) )
