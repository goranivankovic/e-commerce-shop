...
import womenJacket from '../../Img/kid/jakna2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b14 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp2))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/jacket2",  imgName :"/Img/kid/jakna2.jpg", name:ik2, size:btnValue,price:kp2,}) )
