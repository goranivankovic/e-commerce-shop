...
import womenJacket from '../../Img/kid/duks2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b18 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(kp6))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/kid/hoodie2",  imgName :"/Img/kid/duks2.jpg", name:ik6, size:btnValue,price:kp6,}) )
