...
import womenJacket from '../../Img/man/patike3.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b35 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp11))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/shoe3",  imgName :"/Img/man/patike3.jpg", name:im11, size:btnValue,price:mp11}) )
