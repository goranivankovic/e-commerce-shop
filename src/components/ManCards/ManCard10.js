    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b34 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp10))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/shoe2",  imgName :"/Img/man/patike2.jpg", name:im10, size:btnValue,price:mp10}) )
