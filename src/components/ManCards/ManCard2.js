...
import womenJacket from '../../Img/man/muskaJakna.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b26 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp2))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/manjacket2",  imgName :"/Img/man/muskaJakna.jpg", name:im2, size:btnValue,price:mp2,}) )
