...
import womenJacket from '../../Img/man/duks2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b30 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp6))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/hoodie2",  imgName :"/Img/man/duks2.jpg", name:im6, size:btnValue,price:mp6}) )
