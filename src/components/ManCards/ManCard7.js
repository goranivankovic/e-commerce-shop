...
import womenJacket from '../../Img/man/majica.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b31 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp7))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/tshirt",  imgName :"/Img/man/majica.jpg", name:im7, size:btnValue,price:mp7}) )
