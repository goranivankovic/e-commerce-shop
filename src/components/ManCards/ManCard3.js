...
import womenJacket from '../../Img/man/dzemper.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b27 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(mp3))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/man/pullover",  imgName :"/Img/man/dzemper.jpg", name:im3, size:btnValue,price:mp3,}) )
