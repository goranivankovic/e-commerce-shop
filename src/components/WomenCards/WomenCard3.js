...
import womenJacket from '../../Img/women/womenJacket2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b3 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp3))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/womenJacket2", imgName :"/Img/women/womenJacket2.jpg", name:iw3, size:btnValue,price:wp3,}) )
