    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b1 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp1))

             dispatch(nizArray({id:Date.now().toString(), imgLink:"/women/womenJacket",  imgName :"/Img/women/womenJacket.jpg", name:iw1, size:btnValue,price:wp1,}) )
