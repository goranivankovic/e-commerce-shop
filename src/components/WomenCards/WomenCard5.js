...
import womenJacket from '../../Img/women/hodieGirl.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        <div className={womenCardStyle.secondDivImageText}>
          ...
          <div>{   row3Item2  } ||  {  row3Item3  }<hr></hr> </div>
          <div> {iw5} <hr></hr> </div>

         <div>  {wp5} {valuta} <hr></hr></div>  
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b5 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp5))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/hoodie", imgName :"/Img/women/hodieGirl.jpg", name:iw5, size:btnValue,price:wp5,}) )
