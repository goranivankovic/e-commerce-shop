...
import womenJacket from '../../Img/women/womenCoat.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        <div className={womenCardStyle.secondDivImageText}>
          ...
          <div>{   row2Item8  } ||  {  row2Item4  }<hr></hr> </div>
          <div> {iw2} <hr></hr> </div>

         <div>  {wp2} {valuta} <hr></hr></div>  
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b2 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp2))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/womenCoat", imgName :"/Img/women/womenCoat.jpg", name:iw2, size:btnValue,price:wp2,}) )
