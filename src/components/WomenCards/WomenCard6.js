...
import womenJacket from '../../Img/women/tshirt.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b6 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp6))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/tshirt", imgName :"/Img/women/tshirt.jpg", name:iw6, size:btnValue,price:wp6,}) )
