...
import womenJacket from '../../Img/women/tshirt2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b8 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp8))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/tshirt2", imgName :"/Img/women/tshirt2.jpg", name:iw8, size:btnValue,price:wp8,}) )
