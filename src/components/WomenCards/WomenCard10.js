...
import womenJacket from '../../Img/women/shoe2.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b10 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp10))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/heels", imgName :"/Img/women/shoe2.jpg", name:iw10, size:btnValue,price:wp10,}) )
