...
import womenJacket from '../../Img/women/shoe1.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b9 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp9))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/shoe1", imgName :"/Img/women/shoe1.jpg", name:iw9, size:btnValue,price:wp9,}) )
