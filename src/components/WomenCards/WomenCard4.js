...
import womenJacket from '../../Img/women/womenJacket3.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        <div className={womenCardStyle.secondDivImageText}>
          ...
          <div>{   row2Item3  } ||  {  row2Item6  }<hr></hr> </div>
          <div> {iw4} <hr></hr> </div>

         <div>  {wp4} {valuta} <hr></hr></div>  
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b4 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp4))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/womenJacket3", imgName :"/Img/women/womenJacket3.jpg", name:iw4, size:btnValue,price:wp4,}) )
