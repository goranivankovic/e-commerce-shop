...
import womenJacket from '../../Img/women/jeans.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        <div className={womenCardStyle.secondDivImageText}>
          ...
          <div>{   row4Item2  } ||  {  row4Item3  }<hr></hr> </div>
          <div> {iw7} <hr></hr> </div>

         <div>  {wp7} {valuta} <hr></hr></div>  
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b7 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp7))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/jeans", imgName :"/Img/women/jeans.jpg", name:iw7, size:btnValue,price:wp7,}) )
