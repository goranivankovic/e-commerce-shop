...
import womenJacket from '../../Img/women/skirt.jpg'
    ...
    <div>
       ...
       <div className={womenCardStyle.secondDivImage}>
        ...
        <div className={womenCardStyle.secondDivImageText}>
          ...
          <div>{   row1Item3  } ||  {  row4Item2  }<hr></hr> </div>
          <div> {iw12} <hr></hr> </div>

         <div>  {wp12} {valuta} <hr></hr></div>  
        ...
        setBtnValue('S')
         ...
         <div>id : 01054090f21111ec932b12 <hr></hr></div>
     ...
     <Link to="/shop">  <button style={{width:"100%"}}  disabled={!laz} onClick={()=>{ 
             ...
             dispatch(incrementBankAcount(wp12))

             dispatch(nizArray({id:Date.now().toString(),imgLink:"/women/skirt", imgName :"/Img/women/skirt.jpg", name:iw12, size:btnValue,price:wp12,}) )
